...
from src.data_process import data_info, data_view,in_memory
from src.database import connexion, database, import_export
from src.utils import folder,check_kwargs,exceptions
...
# fileInfo.file_info("res/excels/commune.xls")
# data_view.data_view("res/geo/subjects/42-loire/42-.shp",nb_rows_beg = 5,nb_rows_end=10,type="geo")


data_view("res/geo/subjects/42-loire/42-.dbf","A,2","C,4",type="geo")
